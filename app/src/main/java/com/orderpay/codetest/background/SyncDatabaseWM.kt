package com.orderpay.codetest.background
...
class SyncDatabaseWM (appContext: Context, params: WorkerParameters): CoroutineWorker(appContext, params),
    ...
    private val dataSyncRepository: CharactersRepository by inject()

    companion object{
        const val WORK_NAME="com.orderpay.codetest.background.SyncDatabaseWM"
    }
